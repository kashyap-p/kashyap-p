...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=0,2,4,6,8&height=180&section=header&text=Kashyap%20Patel&fontSize=42&fontColor=fff&animation=twinkling&fontAlignY=32&desc=Full-Stack%20Developer%20%7C%20System%20Architect%20%7C%20Problem%20Solver&descAlignY=52&descSize=16" width="100%" alt="Header" />
...
<svg viewBox="0 0 200 140" width="200" height="140" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <linearGradient id="g1" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      <stop offset="100%" stop-color="#f5576c" stop-opacity="0.35"/>
    </linearGradient>
    <linearGradient id="g2" x1="0%" y1="100%" x2="100%" y2="0%">
      <stop offset="0%" stop-color="#a18cd1" stop-opacity="0.25"/>
      <stop offset="100%" stop-color="#43e97b" stop-opacity="0.25"/>
    </linearGradient>
    <linearGradient id="g3" x1="50%" y1="0%" x2="50%" y2="100%">
      <stop offset="0%" stop-color="#f6d365" stop-opacity="0.3"/>
  ...
  <circle r="2" fill="#43e97b">
    <animateMotion dur="7s" repeatCount="indefinite" path="M100,70 m-35,0 a35,35 0 1,0 70,0 a35,35 0 1,0 -70,0"/>
  </circle>
  <circle r="2" fill="#f6d365">
    <animateMotion dur="4s" repeatCount="indefinite" path="M100,70 m-55,0 a55,55 0 1,1 110,0 a55,55 0 1,1 -110,0"/>
  </circle>
</svg>

<br/>

<span style="color: #00d2ff; font-size: 1.8em; font-weight: 700;">Hi, I'm Kashyap Patel</span>
<br/>
<span style="color: #a18cd1; font-size: 1.1em; font-weight: 500;">Full-Stack Developer &middot; Bridging Frontend Creativity &amp; Backend Architecture</span>
...
<p>
  <a href="https://www.linkedin.com/in/kashyap-p">
    <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44">
      ...
      <path fill="white" d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" transform="translate(10, 10)"/>
    </svg>
  </a>
  <a href="https://github.com/kashyap-p">
    <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44">
      <rect width="44" height="44" rx="10" fill="#181717"/>
      <path fill="white" d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12" transform="translate(10, 10)"/>
    </svg>
  </a>
  <a href="mailto:kashyappatel0702@gmail.com">
    <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44">
      <rect width="44" height="44" rx="10" fill="#D14836"/>
      <path fill="white" d="M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 0 1 0 19.366V5.457c0-2.023 2.309-3.178 3.927-1.964L5.455 4.64 12 9.548l6.545-4.91 1.528-1.145C21.691 2.28 24 3.434 24 5.457z" transform="translate(10, 10)"/>
    </svg>
  </a>
...
<span style="color: #00d2ff; font-size: 1.3em;">⚡ &ldquo;From UI mockups to database indexing, I build end-to-end applications that scale.&rdquo;</span>
...
<svg viewBox="0 0 800 45" width="100%" height="45" style="display: block; margin: 10px auto;" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <linearGradient id="wg" x1="0%" y1="0%" x2="100%" y2="0%">
      ...
      <stop offset="25%" stop-color="#a18cd1" stop-opacity="0.15"/>
      <stop offset="50%" stop-color="#f5576c" stop-opacity="0.12"/>
      <stop offset="75%" stop-color="#f6d365" stop-opacity="0.15"/>
      <stop offset="100%" stop-color="#43e97b" stop-opacity="0.08"/>
    </linearGradient>
  </defs>
  <path d="M0,22 Q50,7 100,22 T200,22 T300,22 T400,22 T500,22 T600,22 T700,22 T800,22 L800,45 L0,45 Z" fill="url(#wg)">
    <animate attributeName="d" dur="7s" repeatCount="indefinite" values="
      M0,22 Q50,7 100,22 T200,22 T300,22 T400,22 T500,22 T600,22 T700,22 T800,22 L800,45 L0,45 Z;
      M0,28 Q50,43 100,28 T200,28 T300,28 T400,28 T500,28 T600,28 T700,28 T800,28 L800,45 L0,45 Z;
      M0,22 Q50,7 100,22 T200,22 T300,22 T400,22 T500,22 T600,22 T700,22 T800,22 L800,45 L0,45 Z
    "/>
  </path>
</svg>
...
<svg viewBox="0 0 800 25" width="100%" height="25" style="display: block;" xmlns="http://www.w3.org/2000/svg">
  ...
  <circle cx="250" cy="5" r="1" fill="#f5576c" opacity="0.4">
    <animate attributeName="cx" from="-30" to="830" dur="20s" repeatCount="indefinite"/>
  </circle>
  <circle cx="400" cy="18" r="1.5" fill="#43e97b" opacity="0.4">
    <animate attributeName="cx" from="-30" to="830" dur="17s" repeatCount="indefinite"/>
  </circle>
  <circle cx="550" cy="8" r="1" fill="#f6d365" opacity="0.4">
    <animate attributeName="cx" from="-30" to="830" dur="22s" repeatCount="indefinite"/>
  </circle>
  <circle cx="700" cy="15" r="1.5" fill="#a18cd1" opacity="0.4">
    <animate attributeName="cx" from="-30" to="830" dur="12s" repeatCount="indefinite"/>
  </circle>
</svg>
